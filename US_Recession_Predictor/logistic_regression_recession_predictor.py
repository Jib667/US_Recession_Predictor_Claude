...
class LogisticRegressionRecessionPredictor:
    def __init__(self):
        self.model = None
    ...
    def train(self, df, test_size=0.2, random_state=42):
        ...
        importances = importances / importances.sum()  # Decimal form instead of percentage
    ...
    def predict_recession_probability(self):
        ...
        X = pd.read_csv('US_Recession.csv')[self.feature_order]

        # Calculate feature importances
        importances = np.abs(self.model.coef_[0])
        importances = importances / importances.sum()  # Decimal form
        ...
        for i, feature in enumerate(self.feature_order):
            ...
            results.append({
                ...
                'unit': info['unit'],
                'importance': importances[i]  # Now in decimal form
            })
...
def main():
    try:
        print("Initializing Logistic Regression recession predictor...\n")
        predictor = LogisticRegressionRecessionPredictor()
