...
class LightGBMRecessionPredictor:
    def __init__(self):
        self.model = None
...
def main():
    try:
        print("Initializing LightGBM recession predictor...\n")
        predictor = LightGBMRecessionPredictor()
        ...
        print("pip install pandas numpy scikit-learn lightgbm fredapi")
        raise
